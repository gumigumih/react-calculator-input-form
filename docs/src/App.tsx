            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  React専用電卓入力フォームプラグイン
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <a
                href="https://github.com/gumigumih/react-calculator-input-form"
                target="_blank"
              ...
              <a
                href="https://www.npmjs.com/package/@gumigumih/react-calculator-input-form"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-110"
              >
      ...
      <nav className="hidden md:block sticky top-24 z-10 mb-8">
        <div className="max-w-xl mx-auto bg-white/90 backdrop-blur-md border border-gray-200/50 rounded-xl p-2 shadow-lg">
          <div className="flex flex-wrap justify-center gap-3">
            <a
              href="#features"
              className="px-4 py-2 text-gray-700 hover:text-purple-600 transition-all duration-200 text-sm font-medium"
            >
              特徴
            </a>
            <a
              href="#installation"
              className="px-4 py-2 text-gray-700 hover:text-green-600 transition-all duration-200 text-sm font-medium"
            >
              インストール
            </a>
            <a
            ...
            <a
              href="#demo"
              className="px-4 py-2 text-gray-700 hover:text-indigo-600 transition-all duration-200 text-sm font-medium"
            >
              デモ
            </a>
            <a
            ...
            <a
              href="#colors"
              className="px-4 py-2 text-gray-700 hover:text-pink-600 transition-all duration-200 text-sm font-medium"
            >
              色指定
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">
                    react-number-format完全対応
                  </h3>
                  <p className="text-gray-600 text-sm">
                    通貨記号、カスタムフォーマット等の豊富な機能
                  </p>
                </div>
              </div>
            </div>
      ...
      <section id="colors" className="mb-12">
        <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-gray-600 mb-8">
            `colors` で細かく配色を変えられます。未指定時はデフォルト配色です。
          </p>
...
/>`}</pre>
      ...
      <section id="demo" className="mb-12">
        <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-8 shadow-xl">
          ...
          <div className="grid grid-cols-1 gap-8">
            {/* 基本設定 */}
            <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 transition-all duration-300">
              <div className="mb-4">
                <h3 className="text-xl font-bold text-gray-900">基本設定</h3>
              </div>
              <p className="text-gray-600 mb-4">
                最もシンプルな使用方法。基本的な電卓機能のみを使用します。
              </p>
              <div className="space-y-6">
                {/* デモ */}
                <div>
...
/>`}</pre>
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                モーダルのタイトル、説明文、プレースホルダーをカスタマイズできます。
              </p>
              <div className="space-y-6">
                {/* デモ */}
                <div>
...
/>`}</pre>
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                税込・税抜計算機能を有効にして、8%と10%の税率に対応した計算が可能です。
              </p>
              <div className="space-y-6">
                {/* デモ */}
                <div>
...
/>`}</pre>
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                react-number-formatを使用して、通貨記号や3桁区切りなどの高度なフォーマットが可能です。
              </p>
              <div className="space-y-6">
                {/* デモ */}
                <div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-indigo-900 mb-2">
                        react-number-formatのすべてのプロパティが利用可能
                      </h4>
      ...
      <section id="options" className="mb-12">
        <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-8 shadow-xl">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <h2 className="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-indigo-700 bg-clip-text text-transparent">
              利用可能なオプション一覧
            </h2>
          </div>

          <p className="text-gray-600 mb-4">
            このプラグインで利用可能なすべてのオプションとプロパティについて説明します。
          </p>
          <div className="mb-8">
            <div className="bg-gray-900 text-green-400 p-4 rounded-xl text-sm font-mono overflow-x-auto shadow-inner">
              <pre>{`// 利用可能なオプション例
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody className="bg-white">
                  <tr className="hover:bg-gray-50">
                    <td className="border border-gray-200 px-4 py-3">
                      <code className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm font-medium">
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="border border-gray-200 px-4 py-3 text-sm text-gray-700">
                      数値フォーマット設定（react-number-format準拠）
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <footer className="text-center text-gray-600 py-12 border-t border-gray-200/50">
        <div className="mb-6">
          ...
          <p className="text-lg mb-2">
            ...
            <a
              href="https://github.com/gumigumih"

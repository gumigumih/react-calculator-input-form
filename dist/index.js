...
const CalculatorDisplay = ({ value, error, inputRef }) => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { className: "p-4 bg-gray-50 min-h-[56px] text-right text-2xl font-mono select-none rounded-t", children: jsxRuntime.jsx("div", { ref: inputRef, className: "truncate", children: value ? value : jsxRuntime.jsx("span", { className: "text-gray-400", children: "\u91D1\u984D\u3092\u5165\u529B" }) }) }), error && jsxRuntime.jsx("div", { className: "text-red-500 text-xs px-4 pt-1", children: error })] }));

const Button = ({ children, className = '', ...props }) => (jsxRuntime.jsx("button", { className: `py-2 px-4 rounded-md font-bold focus:outline-none focus:ring-2 transition-colors ${className}`, ...props, children: children }));
...
const CalculatorKeypad = ({ onButtonClick, onEqual, onDecide, onTaxInclude, onTaxExclude }) => (jsxRuntime.jsxs("div", { className: "space-y-2 p-4", children: [jsxRuntime.jsxs("div", { className: "grid grid-cols-4 gap-2", children: [jsxRuntime.jsx(Button, { className: "py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-bold", onClick: () => onTaxInclude(0.08), tabIndex: 0, children: "\u7A0E\u8FBC8%" }), jsxRuntime.jsx(Button, { className: "py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-bold", onClick: () => onTaxInclude(0.10), tabIndex: 0, children: "\u7A0E\u8FBC10%" }), jsxRuntime.jsx(Button, { className: "py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-bold", onClick: () => onTaxExclude(0.08), tabIndex: 0, children: "\u7A0E\u629C8%" }), jsxRuntime.jsx(Button, { className: "py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-bold", onClick: () => onTaxExclude(0.10), tabIndex: 0, children: "\u7A0E\u629C10%" })] }), jsxRuntime.jsxs("div", { className: "grid grid-cols-4 gap-2", children: [BUTTONS$1.flat().map((btn, i) => {
                    ...
                    return (jsxRuntime.jsx(Button, { className: buttonClass, onClick: () => onButtonClick(btn), tabIndex: 0, children: btn }, btn + i));
                }), jsxRuntime.jsx(Button, { className: "col-span-2 py-3 bg-blue-500 hover:bg-blue-600 text-white text-lg font-bold", onClick: onEqual, children: "=" }), jsxRuntime.jsx(Button, { className: "col-span-2 py-3 bg-lime-500 hover:bg-lime-600 text-white text-lg font-bold", onClick: onDecide, children: "\u6C7A\u5B9A" })] })] }));
...
const Calculator = ({ isOpen, onClose, onCalculate, initialValue = '', initialDescription = '', personName, isDetailMode, }) => {
    ...
    if (!isOpen)
        return null;
    const modal = (jsxRuntime.jsx("div", { className: "fixed inset-0 bg-black/50 flex items-center justify-center z-[9999] p-4", children: jsxRuntime.jsxs("div", { className: "bg-white rounded-lg w-full max-w-xs shadow-lg max-h-[80vh] overflow-y-auto", children: [jsxRuntime.jsxs("div", { className: "flex justify-between items-center p-4 border-b border-gray-200", children: [jsxRuntime.jsx("div", { className: "font-bold text-lg text-gray-900", children: personName ? `${personName}さんの金額` : '金額入力' }), jsxRuntime.jsx("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600 transition-colors", children: jsxRuntime.jsx(Icon, { icon: faTimes, className: "w-5 h-5" }) })] }), isDetailMode && (jsxRuntime.jsx("div", { className: "px-4 pt-4", children: jsxRuntime.jsx("input", { type: "text", value: description, onChange: e => setDescription(e.target.value), placeholder: "\u9805\u76EE\u540D\u3092\u5165\u529B", className: "w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 text-base mb-2", autoFocus: true }) })), jsxRuntime.jsx("div", { className: "px-4 pt-2", children: jsxRuntime.jsx("input", { type: "number", value: input, onChange: e => setInput(e.target.value), placeholder: "\u91D1\u984D\u3092\u76F4\u63A5\u5165\u529B", className: "w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 text-base mb-2", min: "0", step: "0.01", inputMode: "decimal" }) }), jsxRuntime.jsx(CalculatorDisplay, { value: formatNumber$1(input), error: error, inputRef: inputRef }), jsxRuntime.jsx(CalculatorKeypad, { onButtonClick: handleButtonClick, onEqual: handleEqual, onDecide: handleDecide, onTaxInclude: handleTaxInclude, onTaxExclude: handleTaxExclude })] }) }));
...
const SplitKeypad = ({ onButtonClick, onEqual, onDecide }) => (jsxRuntime.jsxs("div", { className: "calculator-keypad", children: [jsxRuntime.jsx("div", { className: "calculator-keypad-grid", children: BUTTONS.flat().map((btn, i) => {
                ...
                return (jsxRuntime.jsx(Button, { className: buttonClass, onClick: () => onButtonClick(btn), tabIndex: 0, children: btn }, btn + i));
            }) }), jsxRuntime.jsxs("div", { className: "calculator-action-buttons", children: [jsxRuntime.jsx(Button, { className: "calculator-equals-button", onClick: onEqual, children: "=" }), jsxRuntime.jsx(Button, { className: "calculator-decide-button", onClick: onDecide, children: "\u6C7A\u5B9A" })] })] }));
...
const SplitCalculator = ({ isOpen, onClose, onCalculate, initialParticipants = [], }) => {
    const [participants, setParticipants] = React.useState(initialParticipants.length > 0 ? initialParticipants : [
    ...
    if (!isOpen)
        return null;
    const modal = (jsxRuntime.jsxs("div", { className: "calculator-overlay", children: [jsxRuntime.jsx("div", { className: "calculator-background-pattern", children: jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("div", { className: "calculator-pattern-item", children: "\u00A5" }), jsxRuntime.jsx("div", { className: "calculator-pattern-item", children: "\uD83D\uDED2" }), jsxRuntime.jsx("div", { className: "calculator-pattern-item", children: "\uD83D\uDCB3" }), jsxRuntime.jsx("div", { className: "calculator-pattern-item", children: "\uD83E\uDDEE" }), jsxRuntime.jsx("div", { className: "calculator-pattern-item", children: "\u2708\uFE0F" }), jsxRuntime.jsx("div", { className: "calculator-pattern-item", children: "\uD83D\uDC65" })] }) }), jsxRuntime.jsxs("div", { className: "calculator-modal", children: [jsxRuntime.jsxs("div", { className: "calculator-header", children: [jsxRuntime.jsxs("div", { className: "calculator-logo-container", children: [jsxRuntime.jsx("div", { className: "calculator-logo", children: jsxRuntime.jsx("span", { className: "calculator-logo-text", children: "\u00A5" }) }), jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("h1", { className: "calculator-title", children: "\u308F\u308A\u307E\u308B" }), jsxRuntime.jsx("p", { className: "calculator-subtitle", children: "\u98F2\u307F\u4F1A\u3084\u65C5\u884C\u306E\u652F\u6255\u3044\u3092\u7C21\u5358\u306B\u8A08\u7B97" })] })] }), jsxRuntime.jsx("button", { onClick: onClose, className: "calculator-close-button", children: jsxRuntime.jsx(Icon, { icon: faTimes, className: "w-6 h-6" }) })] }), jsxRuntime.jsxs("div", { className: "calculator-participants", children: [participants.map((participant) => (jsxRuntime.jsxs("div", { className: `calculator-participant-row ${selectedParticipantId === participant.id ? 'selected' : ''}`, onClick: () => handleParticipantSelect(participant.id), children: [jsxRuntime.jsx("div", { className: "calculator-participant-info", children: jsxRuntime.jsx("span", { className: "calculator-participant-name", children: participant.name }) }), jsxRuntime.jsxs("div", { className: "calculator-participant-amount", children: [jsxRuntime.jsx("span", { className: "calculator-amount-text", children: formatNumber(participant.amount) }), jsxRuntime.jsx("span", { className: "calculator-currency", children: "\u5186" }), jsxRuntime.jsx("button", { onClick: (e) => {
                                                    e.stopPropagation();
                                                    handleClearParticipant(participant.id);
                                                }, className: "calculator-clear-button", children: jsxRuntime.jsx(Icon, { icon: faTrash, className: "w-4 h-4" }) })] })] }, participant.id))), jsxRuntime.jsxs("div", { className: "calculator-participant-controls", children: [jsxRuntime.jsx("button", { onClick: addParticipant, className: "calculator-add-button", children: "\u53C2\u52A0\u8005\u3092\u8FFD\u52A0" }), participants.length > 2 && (jsxRuntime.jsx("button", { onClick: () => removeParticipant(participants[participants.length - 1].id), className: "calculator-remove-button", children: "\u524A\u9664" }))] })] }), selectedParticipantId && (jsxRuntime.jsxs("div", { className: "calculator-keypad-section", children: [jsxRuntime.jsx("div", { className: "calculator-display", children: jsxRuntime.jsx("div", { className: "calculator-display-input", children: formatNumber(input) }) }), jsxRuntime.jsx(SplitKeypad, { onButtonClick: handleButtonClick, onEqual: handleEqual, onDecide: handleDecide })] })), jsxRuntime.jsxs("div", { className: "calculator-total-section", children: [jsxRuntime.jsxs("div", { className: "calculator-total-row", children: [jsxRuntime.jsx("span", { className: "calculator-total-label", children: "\u5408\u8A08\u91D1\u984D" }), jsxRuntime.jsxs("span", { className: "calculator-total-amount", children: [formatNumber(String(totalAmount)), "\u5186"] })] }), jsxRuntime.jsx("button", { onClick: calculateResults, className: "calculator-calculate-button", children: "\u8A08\u7B97\u7D50\u679C\u3092\u898B\u308B" })] })] })] }));
    return reactDom.createPortal(modal, document.body);
};
...
exports.Icon = Icon;
exports.SplitCalculator = SplitCalculator;
